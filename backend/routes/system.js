...
router.get('/admin/invite-governance', authMiddleware, systemUserAccessMiddleware, systemAdminMiddleware, systemAdminController.getInviteGovernance.bind(systemAdminController));
router.patch('/admin/invite-governance', authMiddleware, systemUserAccessMiddleware, systemAdminMiddleware, systemAdminController.updateInviteGovernance.bind(systemAdminController));
...
router.patch('/admin/users/:userId/admission-issuer', authMiddleware, systemUserAccessMiddleware, systemAdminMiddleware, systemAdminController.updateUserAdmissionIssuer.bind(systemAdminController));
