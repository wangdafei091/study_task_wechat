...
const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    ANALYTICS_READ_MODEL_QUERY: '/api/analytics/read-model/query',
    ANALYTICS_TASK_COMPLETION_STATS_QUERY: '/api/analytics/task-completion-stats/query',
    ANALYTICS_UPCOMING_EXPIRY_QUERY: '/api/analytics/upcoming-expiry/query',
    ANALYTICS_TASK_STAR_CALENDAR_QUERY: '/api/analytics/task-star-calendar/query',
