...
- [ ] **任务**：统一家庭奖池、家庭兑换记录、孩子个人兑换记录三套查询语义
- [ ] **验证**：奖励页、我的兑换、奖励管理读取结果互不越界
- [ ] **依赖**：第1步
...
- [ ] **任务**：将“保护奖励”改为兑换时动态抵扣规则
- [ ] **验证**：前台不再出现盾牌/免费主语义，展示价与实际扣费一致
- [ ] **依赖**：第3步
...
- [ ] **任务**：落地 `instant/manual` 奖励履约模式
- [ ] **验证**：即时奖励兑换即完成，手动奖励可进入待发放并被家长标记已发放
- [ ] **依赖**：第3步、第4步
