...
- [x] **符合DDD架构**：变更仅限表现层，不动 services/repositories
- [x] **技术方案合理**：weekOffset + 明确翻周入口 + 只读控制方案已落地
- [x] **实施步骤清晰**：实现、回归与真机/模拟器问题已完成收口
- [x] **风险评估充分**：已处理导航可发现性、层级与只读提示边界
- [x] **测试方案完整**：已覆盖日期导航、未来日期只读、历史补打卡等核心场景
...
**意见**：
- 已完成首页日期导航升级、相关测试补齐与手工验证，可作为正式里程碑收口基线。
